/**
 * @file src/components/map/controls/DrawControl.tsx
 * @description MapLibre GL Draw Control wrapper.
 * @compliance POPIA: Handling user-defined geometries.
 */
...
export const DrawControl: React.FC<DrawControlProps> = ({
  ...
  useEffect(() => {
    ...
    const draw = new MapboxDraw({
      ...
      styles: [
        // MapLibre compatible styles for draw features
        {
