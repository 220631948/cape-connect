---
name: tile-agent
description: PMTiles, Tippecanoe, and Martin tile server specialist for the CapeTown GIS Hub. Use for tile generation (Tippecanoe), PMTiles packaging, Martin configuration, zoom level strategy, and offline tile caching for PWA.
