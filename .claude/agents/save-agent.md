---
name: save-agent
description: Saved searches and Dexie.js offline specialist for the CapeTown GIS Hub. Use for favourites, saved search persistence, IndexedDB offline sync, and tenant-scoped saved_searches/favourites tables. Handles M9 scope.
