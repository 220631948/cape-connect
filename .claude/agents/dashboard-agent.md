...
description: Recharts analytics dashboard specialist for the CapeTown GIS Hub. Use for building and updating dashboard widgets, bar/line/pie/choropleth charts, and the AnalyticsDashboard component. Handles M11 scope.
