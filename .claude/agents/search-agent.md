---
name: search-agent
description: Property search and autocomplete specialist for the CapeTown GIS Hub. Use for PostGIS full-text search, autocomplete API routes, search result ranking, and the search UI component. Handles M7 scope.
