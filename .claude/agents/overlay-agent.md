---
name: overlay-agent
description: MVT overlay and risk layer specialist for the CapeTown GIS Hub. Use for zoning, flood risk, fire risk, noise layers, Martin tile server integration, and layer Z-order management. Handles M4b and M5 scope.
