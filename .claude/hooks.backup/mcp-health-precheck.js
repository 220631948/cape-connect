...
const P0_SERVERS = [
  {
    name: "doc-state",
    serverPath: path.join(projectRoot, "mcp", "doc-state", "server.js"),
  },
];
...
const P1_SERVERS = [
  {
    name: "openaware",
    serverPath: path.join(projectRoot, "mcp", "openaware", "server.js"),
  },
  {
    name: "cesium",
    serverPath: path.join(projectRoot, "mcp", "cesium", "server.js"),
  },
  {
    name: "formats",
    serverPath: path.join(projectRoot, "mcp", "formats", "server.js"),
  },
  {
    name: "computerUse",
    serverPath: path.join(projectRoot, "mcp", "computerUse", "server.js"),
  },
  {
    name: "stitch",
    serverPath: path.join(projectRoot, "mcp", "stitch", "server.js"),
  },
];
