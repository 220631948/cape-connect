...
- **Skill:** Execute `.github/copilot/skills/nerf_3dgs_pipeline/SKILL.md` for NeRF/3DGS reconstruction pipelines.
- **Skill:** Execute `.github/copilot/skills/4dgs_event_replay/SKILL.md` for temporal 4DGS event reconstruction.
