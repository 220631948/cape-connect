...
- **Skill:** Execute `.github/copilot/skills/opensky_flight_tracking/SKILL.md` for all OpenSky API integration.
- **Skill:** Execute `.github/copilot/skills/spatial_validation/SKILL.md` to validate flight positions are within the Western Cape bounding box.
